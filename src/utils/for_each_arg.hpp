...
void
for_each_arg(Data& data, U& u, const Op& op) {
  iterate_struct<visit_struct::field_count<Data>() - 1, Data, U,
                 Op>::run(data, u, op);
}

template <typename Data, typename U, typename Op>
void
for_each_arg_with_name(Data& data, U& u, const Op& op) {
  iterate_struct<visit_struct::field_count<Data>() - 1, Data, U,
                 Op>::run_with_name(data, u, op);
}
