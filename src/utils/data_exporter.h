...
////////////////////////////////////////////////////////////////////////////////
///  Struct that contains a data object for Silo hdf5, that is unassociated with
///  any mesh.
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
///  Struct that contains an array object for Silo hdf5, that is unassociated
///  with any mesh.
////////////////////////////////////////////////////////////////////////////////
struct silo_dbArray {
  std::string varName;         //!< Name of the single variable
...
/// The object should be initialized with an output directory, a file prefix
/// format, and a default numbering scheme.
///
/// The object should also be initialized with a quadmesh, and the field names
/// that are defined on the mesh. The fields are the quantities that get written
/// to the output file. The mesh should be in float format, with a name, array
/// of dimensions, number of dimensions, array of grid point locations.
///
/// Can select whether to use double as output format(TODO: implement this
/// feature).
/// The default is to use double, but turning it off can save a lot of disk
/// space.
/// Can also select whether to use compression, which is on by default.
///
...
class DataExporter {
 public:
  ...
  struct AddMesh_t {
    ...
    void operator()(const Metric& g, const char* meshName, int dim, const Grid& grid, DataExporter &exporter);
  } AddMesh;
 ...
 private:
  ...
  std::vector<silo_quadVariable<float> > quadVarsF;  //!< All the quadVar objects
  std::vector<silo_quadVariable<double> > quadVarsD;  //!< All the quadVar objects
  ...
  // bool useDouble;                         //!< Whether to use double for data
  // writes, false to save disk space
