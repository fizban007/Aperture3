...
std::unordered_map<std::string, high_resolution_clock::time_point> timer::t_stamps;
high_resolution_clock::time_point timer::t_now = high_resolution_clock::now();
...
void
timer::show_duration_since_stamp(const std::string& routine_name, const std::string& unit, const std::string& stamp_name) {
