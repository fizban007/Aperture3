...
void
Grid_LogSph_dev::init(const SimParams& params) {
  Grid::init(params);
  if (m_mesh.dim() == 2) {
...
Grid_LogSph_dev::mesh_ptrs
Grid_LogSph_dev::get_mesh_ptrs() const {
  mesh_ptrs ptrs;
...
void
Grid_LogSph_dev::compute_flux(cu_scalar_field<Scalar>& flux,
