...
CommandArgs::CommandArgs() {
  ...
  m_options->add_options()
      ...
      ("s,steps",
       ...
       cxxopts::value<uint32_t>()->default_value(std::to_string(defaults.max_steps)))
      ("d,interval",
       "The interval to output data to the hard disk.",
       cxxopts::value<uint32_t>()->default_value(std::to_string(defaults.data_interval)))
      ("x,dimx",
