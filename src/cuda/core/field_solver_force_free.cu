...
#include "cuda/core/field_solver_force_free.h"
...
void
FieldSolver_FFE::update_fields(cu_sim_data& data, double dt,
                               double time) {}
...
void
FieldSolver_FFE::update_field_substep(vfield_t& E_out, vfield_t& B_out,
                                      vfield_t& J_out,
                                      const vfield_t& E_in,
