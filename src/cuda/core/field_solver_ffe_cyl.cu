...
#include "cuda/core/field_solver_ffe_cyl.h"
...
template <int DIM1>
__global__ void
lower_z_boundary(cudaPitchedPtr e1, cudaPitchedPtr e2,
                 cudaPitchedPtr e3, cudaPitchedPtr b1,
...
void
curl_add_2d(cu_vector_field<Scalar>& result,
            const cu_vector_field<Scalar>& u, Scalar q) {
