...
Grid_1dGR::init(const SimParams& params) {
  ...
  m_D1.resize(m_mesh.dims[0]);
  m_D1.assign(0.0);
  m_D2.resize(m_mesh.dims[0]);
  m_D2.assign(1.0);
  m_D3.resize(m_mesh.dims[0]);
  m_D3.assign(0.0);
  m_alpha_grr.resize(m_mesh.dims[0]);
  m_alpha_grr.assign(1.0);
  m_A.resize(m_mesh.dims[0]);
  m_A.assign(1.0);
  m_a2.resize(m_mesh.dims[0]);
  m_a2.assign(1.0);
  m_angle.resize(m_mesh.dims[0]);
  m_angle.assign(0.0);
}
